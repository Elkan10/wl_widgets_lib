...
mod tests {
    ...
    fn test() {
        ...
        let mut widget = WidgetBuilder::new(&conn, 300, 300).layer(Layer::Overlay).anchor(Anchor::Top).exclusive_zone(1).build();

        widget.create_surface("rust-widget".into());
